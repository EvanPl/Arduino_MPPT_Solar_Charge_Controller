...
This document explains the construction of an Arduino based Maximum Power Point Tracking (MPPT) solar charge controller, capable of charging
a 2V sealed lead acid battery which can drive the following two loads:
* A 2V LED
